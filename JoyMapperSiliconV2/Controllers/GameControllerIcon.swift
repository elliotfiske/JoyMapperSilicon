...
@MainActor func GameControllerIcon(for controller: GameController) -> NSImage {
...
@MainActor private func drawBatteryIcon(for controller: GameController) {
...
@MainActor private func createProConIcon(for controller: GameController) -> NSImage {
    guard
...
@MainActor private func createJoyConLIcon(for controller: GameController) -> NSImage {
...
@MainActor private func createJoyConRIcon(for controller: GameController) -> NSImage {
